...
import { logsUtils, type LogRecord } from "@/firebase/logs-utils";
            ...
            <div className='hidden sm:flex sm:flex-1 sm:items-center sm:justify-between'>
              ...
              <div>
                ...
                >
                  ...
                  <div className='flex items-center border-y border-input bg-background px-4 py-2 text-sm font-semibold'>
