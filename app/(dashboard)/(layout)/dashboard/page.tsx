          ...
          <div className='flex min-h-[400px] flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted bg-muted/5 p-8 transition-all hover:bg-muted/10'>
            ...
            {user && (
              <div className='mt-4 text-center text-sm text-muted-foreground'>
                <p>You can create up to {user.remainingAgents} more agents on your current plan</p>
              </div>
            )}
          </div>
                ...
                <Tooltip>
                  <TooltipTrigger>
                    <Badge variant='outline' className='text-xs'>
                      {stats?.totalEmails || 0}/{user.remainingEmailSent} emails remaining
                    </Badge>
                  </TooltipTrigger>
                  <TooltipContent>
            ...
            <CardFooter className='pt-0'>
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger>
                    <Badge variant='outline' className='text-xs'>
                      {user.remainingAgents} agents remaining
                    </Badge>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>Based on your current plan</p>
        ...
        <Card className='transition-all hover:shadow-md'>
          ...
          {user && (
            <CardFooter className='text-xs text-muted-foreground'>
              You can create up to {user.remainingAgents} more agents on your current plan
            </CardFooter>
          )}
        </Card>
