...
import { emailHistoryUtils } from '../../../lib/firebase/emailHistoryUtils'
...
import { WelcomeAgent } from '../../../lib/types/welcome-agent'
  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      ...
      try {
        ...
        const emailResult = await emailHistoryUtils.getEmailHistory(
          workspace.id,
          null,
          1,
          1000,
        ...
        const totalSentEmails = allEmails.filter(
          (e) => e.status === 'sent',
        ).length
        const emailsPending = allEmails.filter(
        ...
        const recentEmails = allEmails
          ...
          .map((email) => {
            let message = ''
            let type: 'email_sent' | 'email_pending' | 'agent_created' =
              'email_pending'
        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center justify-center min-h-[400px] p-8 border-2 border-dashed border-gray-200 rounded-lg">
            ...
            <p className="text-gray-600 text-center max-w-md mb-8">
              Get started by creating a welcome agent that will automatically
              send personalized emails to your new signups.
            </p>
            ...
            <CardContent>
              <div className="text-center py-8">
                <p className="text-sm text-gray-500">
                  Activity will appear here once you create your first welcome
                  agent
                </p>
              </div>
            </CardContent>
