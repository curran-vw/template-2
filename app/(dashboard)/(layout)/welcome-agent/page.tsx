  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-8 border-2 border-dashed border-gray-200 rounded-lg">
      ...
      <p className="text-gray-500 text-center mb-8 max-w-md">
        Create your first welcome agent to start automating your personalized
        welcome emails
      </p>
      <Button
        size="lg"
  ...
  useEffect(() => {
    const loadAgents = async () => {
      ...
      try {
        ...
        const loadedAgents = await welcomeAgentUtils.getWorkspaceWelcomeAgents(
          workspace.id,
        )
      ...
      <CardContent className="border-t pt-6">
        <div className="flex items-center justify-between">
          ...
          {agent.status === 'published' &&
            agent.emailsSentToday !== undefined && (
