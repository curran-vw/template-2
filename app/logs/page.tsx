...
import { logsUtils, LogRecord } from '../lib/firebase/logsUtils'
...
export default function LogsPage() {
  ...
  if (
    !user ||
    (user.email !== 'curranvw@gmail.com' &&
      user.email !== 'abdelr7manabdelmoaty@gmail.com')
  ) {
    return (
          ...
          <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                ...
                of <span className="font-medium">{pagination.totalLogs}</span>{' '}
                results
              </p>
            </div>
            <div>
